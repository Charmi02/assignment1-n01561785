module "rgroup" {
  source = "./modules/rgroup-n01561785"

  resource_group_name = "1785-RG"
  location            = "Australia East"
}

module "network" {
  source = "./modules/network-n01561785"
  resource_group_name    = module.rgroup.resource_group_name
  location               = module.rgroup.location
  vnet_name              = "1785-vnet"
  vnet_address_space     = ["10.0.0.0/16"]
  subnet_name            = "1785-subnet"
...
module "common" {
  source = "./modules/common-n01561785"
...
module "linux_vms" {
  source              = "./modules/vmlinux-n01561785"
  resource_group_name = module.rgroup.resource_group_name
  location            = module.rgroup.location
  linux_avs           = "linux-avs"
...
module "windows_vms" {
  source              = "./modules/vmwindows-n01561785"
  resource_group_name = module.rgroup.resource_group_name
  location            = module.rgroup.location
  subnet_id           = module.network.subnet_id
  storage_account_uri = module.common.storage_account_blob_endpoint
...
module "data_disks" {
  source              = "./modules/datadisk-n01561785"
  resource_group_name = module.rgroup.resource_group_name
  location            = module.rgroup.location
 vm_ids = zipmap(
    concat(
...
module "loadbalancer" {
  source              = "./modules/loadbalancer-n01561785"
  resource_group_name = module.rgroup.resource_group_name
  location            = module.rgroup.location
...
module "database" {
  source              = "./modules/database-n01561785"
  resource_group_name = module.rgroup.resource_group_name
  location            = module.rgroup.location
  common_tags         = module.rgroup.tags
}
